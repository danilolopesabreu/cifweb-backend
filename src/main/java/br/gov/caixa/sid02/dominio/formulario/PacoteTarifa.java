...
public class PacoteTarifa implements java.io.Serializable {private static final long serialVersionUID = 1L;
	...
	public PacoteTarifa(PacoteTarifaId id, SlctoManutencaoCif slctoManutencaoCif, char icPacoteTarifa,
			String coUsuario) {
		this.id = id;
	...
	public PacoteTarifa(PacoteTarifaId id, SlctoManutencaoCif slctoManutencaoCif, char icPacoteTarifa, Date fimVigencia,
			String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
		this.icPacoteTarifa = icPacoteTarifa;
	...
	public char getIcPacoteTarifa() {
		return this.icPacoteTarifa;
	}

	public void setIcPacoteTarifa(char icPacoteTarifa) {
		this.icPacoteTarifa = icPacoteTarifa;
	}
