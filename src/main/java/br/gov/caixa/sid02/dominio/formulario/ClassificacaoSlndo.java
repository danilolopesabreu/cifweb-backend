 ...
 */
@Entity
@Table(name = "D02TB258_CLASSIFICACAO_SLNDO")
public class ClassificacaoSlndo implements java.io.Serializable {private static final long serialVersionUID = 1L;

	private ClassificacaoSlndoId id;
	private SlctoManutencaoCif slctoManutencaoCif;
	private Date fimVigencia;
	private String coUsuario;

	public ClassificacaoSlndo() {
	}

	public ClassificacaoSlndo(ClassificacaoSlndoId id, SlctoManutencaoCif slctoManutencaoCif, String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
		this.coUsuario = coUsuario;
	}

	public ClassificacaoSlndo(ClassificacaoSlndoId id, SlctoManutencaoCif slctoManutencaoCif, Date fimVigencia,
			String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
	...
	public ClassificacaoSlndoId getId() {
		return this.id;
	}

	public void setId(ClassificacaoSlndoId id) {
		this.id = id;
	}
