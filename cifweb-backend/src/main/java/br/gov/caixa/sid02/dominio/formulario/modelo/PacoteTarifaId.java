 ...
 */
@Embeddable
public class PacoteTarifaId implements java.io.Serializable {private static final long serialVersionUID = 1L;
	...
	public PacoteTarifaId() {
	}

	public PacoteTarifaId(int nuSqnclSlctoMntnoCif, int nuSequencialCifServico, byte nuAcao, byte nuModo, byte nuGrupo,
			Date inicioVigencia) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PacoteTarifaId))
			return false;
		PacoteTarifaId castOther = (PacoteTarifaId) other;
