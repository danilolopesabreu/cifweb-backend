...
public class SaldoRsrvaSclCndoId implements java.io.Serializable { private static final long serialVersionUID = 1L;
	...
	public SaldoRsrvaSclCndoId(short nuAcao, short nuModo, short nuGrupo, int nuSequencialCifServico,
			int nuSqnclCifPrpreFrmro, short nuAtrzaSldoRsrvaScl, Date inicioVigencia) {
		this.nuAcao = nuAcao;
		this.nuModo = nuModo;
