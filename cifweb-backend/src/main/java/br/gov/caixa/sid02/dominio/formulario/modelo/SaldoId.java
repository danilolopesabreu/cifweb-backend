 ...
 */
@Embeddable
public class SaldoId implements java.io.Serializable { private static final long serialVersionUID = 1L;
	...
	private short nuTipoSaldo;
	private Date inicioVigencia;

	public SaldoId() {
	}

	public SaldoId(short nuAcao, short nuModo, short nuGrupo, int nuSequencialCifServico, int nuSqnclSlctoMntnoCif,
			short nuTipoSaldo, Date inicioVigencia) {
		this.nuAcao = nuAcao;
		this.nuModo = nuModo;
		this.nuGrupo = nuGrupo;
		this.nuSequencialCifServico = nuSequencialCifServico;
		this.nuSqnclSlctoMntnoCif = nuSqnclSlctoMntnoCif;
		this.nuTipoSaldo = nuTipoSaldo;
	...
	@Column(name = "NU_TIPO_SALDO_P48", nullable = false, precision = 3, scale = 0)
	public short getNuTipoSaldo() {
		return this.nuTipoSaldo;
	}

	public void setNuTipoSaldo(short nuTipoSaldo) {
		this.nuTipoSaldo = nuTipoSaldo;
	}
	...
	public boolean equals(Object other) {
		...
		return (this.getNuAcao() == castOther.getNuAcao()) && (this.getNuModo() == castOther.getNuModo())
				...
				&& (this.getNuTipoSaldo() == castOther.getNuTipoSaldo())
	...
	public int hashCode() {
		...
		result = 37 * result + this.getNuTipoSaldo();
