...
/**
 * SlctoCifDscroEspfaId
 */
@Embeddable
public class SlctoCifDscroEspfaId implements java.io.Serializable { private static final long serialVersionUID = 1L;
	...
	public SlctoCifDscroEspfaId() {
	}

	public SlctoCifDscroEspfaId(short nuAcao, short nuModo, short nuGrupo, int nuSequencialCifServico,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SlctoCifDscroEspfaId))
			return false;
		SlctoCifDscroEspfaId castOther = (SlctoCifDscroEspfaId) other;
