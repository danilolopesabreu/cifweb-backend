 ...
 */
@Entity
@Table(name = "D02TB266_CANAL")
public class Canal implements java.io.Serializable {	private static final long serialVersionUID = 1L;
	...
	public Canal(CanalId id, SlctoManutencaoCif slctoManutencaoCif, String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
		this.coUsuario = coUsuario;
	}

	public Canal(CanalId id, SlctoManutencaoCif slctoManutencaoCif, Date fimVigencia, String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
