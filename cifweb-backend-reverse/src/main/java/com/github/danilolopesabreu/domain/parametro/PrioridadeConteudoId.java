...
public class PrioridadeConteudoId implements java.io.Serializable { private static final long serialVersionUID = 1L;
	...
	public PrioridadeConteudoId(short nuAcao, short nuModo, short nuGrupo, int nuSequencialCifServico,
			int nuSqnclCifPrpreFrmro, int nuPrioridade, Date inicioVigencia) {
		this.nuAcao = nuAcao;
		this.nuModo = nuModo;
