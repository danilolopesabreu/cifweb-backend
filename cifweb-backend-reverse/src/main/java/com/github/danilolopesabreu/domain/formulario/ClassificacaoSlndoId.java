...
/**
 * ClassificacaoSlndoId
 */
@Embeddable
public class ClassificacaoSlndoId implements java.io.Serializable { private static final long serialVersionUID = 1L;
	...
	public ClassificacaoSlndoId() {
	}

	public ClassificacaoSlndoId(short nuAcao, short nuModo, short nuGrupo, int nuSequencialCifServico,
			int nuSqnclSlctoMntnoCif, Date inicioVigencia, short nuClassificacaoLncmo) {
		this.nuAcao = nuAcao;
		this.nuModo = nuModo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClassificacaoSlndoId))
			return false;
		ClassificacaoSlndoId castOther = (ClassificacaoSlndoId) other;
