 ...
 */
@Entity
@Table(name = "D02TB257_FNCNE_ESPECIAL_SLNDO")
public class FncneEspecialSlndo implements java.io.Serializable { private static final long serialVersionUID = 1L;

	private FncneEspecialSlndoId id;
	private SlctoManutencaoCif slctoManutencaoCif;
	private Date fimVigencia;
	private String coUsuario;

	public FncneEspecialSlndo() {
	}

	public FncneEspecialSlndo(FncneEspecialSlndoId id, SlctoManutencaoCif slctoManutencaoCif, String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
		this.coUsuario = coUsuario;
	}

	public FncneEspecialSlndo(FncneEspecialSlndoId id, SlctoManutencaoCif slctoManutencaoCif, Date fimVigencia,
			String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
	...
	public FncneEspecialSlndoId getId() {
		return this.id;
	}

	public void setId(FncneEspecialSlndoId id) {
		this.id = id;
	}
