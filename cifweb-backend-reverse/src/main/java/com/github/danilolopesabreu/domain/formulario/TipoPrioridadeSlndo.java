 ...
 */
@Entity
@Table(name = "D02TB256_TIPO_PRIORIDADE_SLNDO")
public class TipoPrioridadeSlndo implements java.io.Serializable { private static final long serialVersionUID = 1L;

	private TipoPrioridadeSlndoId id;
	private SlctoManutencaoCif slctoManutencaoCif;
	private Date fimVigencia;
	private String coUsuario;

	public TipoPrioridadeSlndo() {
	}

	public TipoPrioridadeSlndo(TipoPrioridadeSlndoId id, SlctoManutencaoCif slctoManutencaoCif, String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
		this.coUsuario = coUsuario;
	}

	public TipoPrioridadeSlndo(TipoPrioridadeSlndoId id, SlctoManutencaoCif slctoManutencaoCif, Date fimVigencia,
			String coUsuario) {
		this.id = id;
		this.slctoManutencaoCif = slctoManutencaoCif;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "nuPrioridade", column = @Column(name = "NU_PRIORIDADE_P55", nullable = false, precision = 5, scale = 0)),
			@AttributeOverride(name = "inicioVigencia", column = @Column(name = "DT_INICIO_VIGENCIA", nullable = false, length = 7)) })
	public TipoPrioridadeSlndoId getId() {
		return this.id;
	}

	public void setId(TipoPrioridadeSlndoId id) {
		this.id = id;
	}
