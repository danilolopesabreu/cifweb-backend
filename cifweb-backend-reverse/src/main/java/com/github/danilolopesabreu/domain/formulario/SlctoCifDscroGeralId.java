...
/**
 * SlctoCifDscroGeralId
 */
@Embeddable
public class SlctoCifDscroGeralId implements java.io.Serializable { private static final long serialVersionUID = 1L;
	...
	public SlctoCifDscroGeralId() {
	}

	public SlctoCifDscroGeralId(short nuAcao, short nuModo, short nuGrupo, int nuSequencialCifServico,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SlctoCifDscroGeralId))
			return false;
		SlctoCifDscroGeralId castOther = (SlctoCifDscroGeralId) other;
